      ...
      <div className="max-w-2xl mx-auto px-3 sm:px-6 md:px-8 py-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5 mb-6">
          <div className="arcade-plate px-4 sm:px-5 py-2.5 flex items-center gap-2">
            ...
            <span className="arcade-font" style={{ fontSize: "clamp(6px, 1.5vw, 9px)", color: "#ffd866" }}>NEW STORE</span>
            <span className="arcade-font" style={{ fontSize: "clamp(6px, 1.5vw, 9px)", color: "#EBE9D9" }}>500</span>
          </div>
          <div className="arcade-plate px-4 sm:px-5 py-2.5 flex items-center gap-2">
            <span style={{ fontSize: "14px" }}>✏️</span>
            <span className="arcade-font" style={{ fontSize: "clamp(6px, 1.5vw, 9px)", color: "#c8d4ff" }}>EDIT</span>
            <span className="arcade-font" style={{ fontSize: "clamp(6px, 1.5vw, 9px)", color: "#EBE9D9" }}>300</span>
          </div>
        </div>
          ...
          {!loading && entries.map((entry, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="arcade-font flex-1 truncate" style={{ fontSize: "clamp(8px, 1.8vw, 11px)", color, letterSpacing: "0.03em" }}>
        ...
        {/* ── SPEAKER GRILLE ── */}
        <div className="arcade-grille h-4 mt-8 mx-auto" style={{ maxWidth: "220px" }} />
