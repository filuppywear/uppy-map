...
const RANK_COLORS = [
  "#EBE9D9", // #1 gold/cream
  "rgba(255,255,255,0.65)", // #2 silver
  "#A58277", // #3 bronze/tertiary
];
...
export default function LeaderboardView() {
  ...
  return (
    <div className="h-full overflow-y-auto" style={{ background: "#302020" }}>
      ...
      <div className="relative z-[2] max-w-2xl mx-auto px-4 md:px-8 py-10 pb-28 lg:pb-10">
        ...
        {!loading && entries.map((entry, i) => {
          ...
          return (
            ...
            >
              {/* Rank */}
              <span
                className="arcade-font w-10 md:w-14 shrink-0"
                style={{ fontSize: "clamp(9px, 2vw, 12px)", color }}
              >
                {padRank(i + 1)}
              </span>
              ...
              {/* Score */}
              <span
                className="arcade-font w-20 md:w-28 text-right shrink-0"
                style={{ fontSize: "clamp(9px, 2vw, 12px)", color }}
              >
        ...
        <div className="text-center mt-12">
          <p
            className="arcade-font arcade-blink"
